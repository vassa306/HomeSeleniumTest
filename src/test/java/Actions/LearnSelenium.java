...
public class LearnSelenium extends HomepageActions {
    ...
    public void checkPageTitle() throws Exception {
        ...
        Assert.assertEquals(test, "Registe", "Actual value is " + test);
        Thread.sleep(3000);
        System.out.println("Tab is " + test);
    }
    ...
    //DU
    //vyzkoušet stejnou metodu  pro Email Adress a phone
    //link na https://www.guru99.com/xpath-selenium.html/
